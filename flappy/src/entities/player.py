...
class Player(Entity):
    def __init__(self, config: GameConfig) -> None:
        ...
        x = int(config.window.width * 0.48)
    ...
    def reset_vals_normal(self) -> None:
        self.vel_y = -3  # player's velocity along Y axis -> 9
        self.max_vel_y = 5  # max vel along Y, max descend speed -> 10
        self.min_vel_y = -1  # min vel along Y, max ascend speed -> -8
