...
class Images:
    ...
    def __init__(self) -> None:
        self.numbers = list(
            (
                pygame.image.load(f"flappy/assets/sprites/{num}.png").convert_alpha()
                for num in range(10)
            )
        )
        ...
        self.game_over = pygame.image.load(
            "flappy/assets/sprites/gameover.png"
        ).convert_alpha()
        # welcome_message sprite for welcome screen
        self.welcome_message = pygame.image.load(
            "flappy/assets/sprites/message.png"
        ).convert_alpha()
        # base (ground) sprite
        self.base = pygame.image.load("flappy/assets/sprites/base.png").convert_alpha()
        self.randomize()
